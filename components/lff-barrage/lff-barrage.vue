<template>
	<cover-view style="overflow: hidden;position: fixed;width: 100%;height: 300rpx;pointer-events: none; top: 128rpx;">
		<cover-view class="danmu-li" v-for="(item,index) in listData" :class="item.type" :style="item.style" :key="index">
			<cover-view class="danmu-inner">
				<cover-view class="user-box">
					<cover-view class="user-img">
						<cover-view class="img-box">
							<cover-image src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=317894666,3379114684&fm=26&gp=0.jpg"></cover-image>
						</cover-view>
					</cover-view>
					<cover-view class="user-text cl1">
						人名
					</cover-view>
					<cover-view class="user-status cl1">
						{{item.item}}
					</cover-view>
				</cover-view>
			</cover-view>
